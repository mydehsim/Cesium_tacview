...
inline QString controlModeToString(ControlMode m) {
    switch (m) {
    case ControlMode::IDLE:      return QStringLiteral("IDLE");
    case ControlMode::MANUAL:    return QStringLiteral("MANUAL");
    case ControlMode::AUTOPILOT: return QStringLiteral("AUTOPILOT");
    case ControlMode::SCRIPTED:  return QStringLiteral("SCRIPTED");
    }
...
struct AircraftState {
    ...
    struct TrailPoint { double lat; double lon; double alt; };
